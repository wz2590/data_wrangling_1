...
``` r
# first add a new column naming wt_gain and do the calculation
# then change all characters in the name column to lower case
mutate(litters_df, 
...
``` r
# df, first_priority, second_priority
